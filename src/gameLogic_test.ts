describe("In Backgammon", function() {
  ...
  function expectMove(
      ...
      let turnsBeforeMove: ITurnDelta[] = [{originalSteps:originalSteps, currentSteps:currentStepsBeforeMove, moves: null}];
    ...
    let stateTransition: IStateTransition = {
      ...
      stateBeforeMove: boardBeforeMove ? {board: boardBeforeMove, delta: {turns: turnsBeforeMove}} : null,
      move: {
